<?php
// Assuming $paginated_items, $total_pages, $current_page, $keyword, and $offset are passed to this component
// from the controller.
?>

<div class="max-w-5xl p-6 mx-auto bg-white border border-green-200 shadow rounded-xl">
