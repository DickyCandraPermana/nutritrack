<form id="edit-formEditUser" onsubmit="editUser(); return false;" class="w-full p-8 space-y-8 bg-white shadow rounded-xl" enctype="multipart/form-data">
  ...
  <div class="grid grid-cols-2 gap-6">
    ...
    <div>
      <label for="edit-password" class="block mb-1 font-semibold text-gray-700">Password</label>
      <input type="password" name="password" id="edit-password" required class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500" />
    </div>
